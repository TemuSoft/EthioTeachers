            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (cursor.moveToFirst()) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(DeleteStudents.this);
                        ...
                        builder.setNegativeButton("Detail", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    Intent intent = new Intent(DeleteStudents.this, ListViewClass.class);
                                    ...
                                    if (cursor.moveToFirst()) {
                                        do {
                                            resultHolder[totalCount] = "Name :" + cursor.getString(2) + " " + cursor.getString(3) + " " + cursor.getString(4)
                                                    ...
                                                    + "\n" + showSemester() + " " + checkAgeWantOrNot()
                                                    + showSubject() + " " + showPhone_Num() + "\n";
                                            gradeHolder[totalCount] = cursor.getString(0);
                                            numberHolder[totalCount] = cursor.getString(1);
                                            totalCount++;
                                        } while (cursor.moveToNext());
                        ...
                        Toast.makeText(DeleteStudents.this, "no similar data found", Toast.LENGTH_SHORT).show();
                } catch (Exception t) {
    ...
    private void seeCheckedBox() {
        ...
        if (checkBox8.isChecked()) {
            if (!editText8.getText().toString().isEmpty())
                ...
                SearchByNumber = " and StudentData.Number is null ";
        }
        if (checkBox9.isChecked()) {
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy");
            Date date = new Date();
            ...
            try {
                ...
                SearchByBirth_Date = " and StudentData.Birth_Daten like 'b%' ";
                Toast.makeText(this, "Age is null!", Toast.LENGTH_SHORT).show();
            }
        }
        if (checkBox10.isChecked()) {
