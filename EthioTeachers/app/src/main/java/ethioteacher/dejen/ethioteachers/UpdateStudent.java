...
public class UpdateStudent extends Activity {
    ...
    private String updateRequest[] = new String[10];

    private CheckBox checkBox, checkBox2, checkBox3, checkBox5;
    private CheckBox checkBox6, checkBox9, checkBox10, checkBox11, checkBox12;

    private TextView textView;

    private EditText editText, editText2, editText3, editText5;
    private EditText editText6, editText9, editText10;

    private Button button, button2;
    private Cursor cursor;
    private SQLiteDatabase db;
    private String SearchBySname = "", SearchByFname = "", SearchByGFname = "";
    private String SearchBySubject = "", SearchByPhone_number = "", SearchByBirth_Date = "", SearchBySex = "";
    private String sqlSelectCommand;
    private String SemesterFirstOrSecond = "First";

    private SharedPreferences preferences;
    private LinearLayout layoutCheckbox, layoutEdittext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutEdittext = (LinearLayout) findViewById(R.id.editTextLayout);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    sqlSelectCommand = "select * from StudentData inner join StudentValue" + SemesterFirstOrSecond + " on "
                            ...
                            + SearchBySname + SearchByFname + SearchByGFname
                            + SearchBySubject + SearchByPhone_number + SearchByBirth_Date
                            + SearchBySex;
                    updateRequest[0] = SearchBySname;
                    updateRequest[1] = SearchByFname;
                    updateRequest[2] = SearchByGFname;
                    updateRequest[3] = "";
                    updateRequest[4] = SearchBySubject;
                    updateRequest[5] = SearchByPhone_number;
                    updateRequest[6] = "";
                    updateRequest[7] = "";
                    updateRequest[8] = SearchByBirth_Date;
                    updateRequest[9] = SearchBySex;
                    ...
                    if (cursor.moveToFirst()) {
                        ...
                        builder.setNegativeButton("Detail", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    Intent intent = new Intent(UpdateStudent.this, ListViewClass.class);
                                    ...
                                    if (cursor.moveToFirst()) {
                                        do {
                                            resultHolder[totalCount] = "Name :" + cursor.getString(2) + " " + cursor.getString(3) + " " + cursor.getString(4)
                                                    ...
                                                    + "\n" + showSemester() + " " + checkAgeWantOrNot() + showSubject() + " " + showPhone_Num() + "\n";
                                            gradeHolder[totalCount] = cursor.getString(0);
                                            numberHolder[totalCount] = cursor.getString(1);
                                            totalCount++;
                                        } while (cursor.moveToNext());
                        ...
                        Toast.makeText(UpdateStudent.this, "no similar data found", Toast.LENGTH_SHORT).show();
                } catch (Exception t) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(UpdateStudent.this, UpdateStudentMore.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
